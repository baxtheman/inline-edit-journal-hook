					...
					<c:when test="<%= (articleDisplay != null) && !expired %>">
						...
						<div class="journal-content-article">
							...
							<c:if test="<%= inlineEditEnabled %>">
								<div <%= inlineEditEnabled ? "class=\"lfr-editable\" contenteditable=\"true\" id=\"" + articleId + "\" spellcheck=\"false\"" : "" %>>
							</c:if>
						...
						<c:if test="<%= inlineEditEnabled %>">
							<portlet:actionURL var="updateContent">
								<portlet:param name="struts_action" value="/journal_content/edit_article_inline" />
							...
							<liferay-ui:input-editor
								editorImpl="ckeditor"
								inlineEdit="<%= true %>"
								inlineEditSaveURL="<%= updateContent %>"
								name="<%= articleId %>"
							/>
						</c:if>
